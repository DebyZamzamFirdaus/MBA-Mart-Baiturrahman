...
function mining_process($db_object, $min_support, $min_confidence, $start_date, $end_date, $id_process){
	...
	<div class='card shadow mb-4'>
        <div class='card-header py-3'>
            <h6 class='m-0 font-weight-bold text-success'><i class='fa fa-table'></i> Itemset 1</h6>
        </div>
        <div class='card-body'>";
    ...
    foreach ($item_list as $key => $item) {
        ...
        echo "<td class='text-center'>" . (($lolos==1)?"<span class='badge badge-success'>Lolos</span>":"<span class='badge badge-danger'>Tidak Lolos</span>") . "</td>";
        echo "</tr>";
        $x++;
    }
    echo "</table></div></div>";
    ...
    echo "<div class='card shadow mb-4'>
        <div class='card-header py-3'>
            <h6 class='m-0 font-weight-bold text-success'><i class='fa fa-table'></i> Itemset 2</h6>
        </div>
        <div class='card-body'>";
    echo "<table class='table table-bordered' width='100%' cellspacing='0'>
            <thead class='bg-success text-white'>
    ...
    echo "<div class='card shadow mb-4'>
        <div class='card-header py-3'>
            <h6 class='m-0 font-weight-bold text-success'><i class='fa fa-table'></i> Itemset 3</h6>
        </div>
        <div class='card-body'>";
    echo "<table class='table table-bordered' width='100%' cellspacing='0'>
            <thead class='bg-success text-white'>
