...
?>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-success"><i class="fa fa-table"></i> Confidence Dari Itemset 3</h6>
        </div>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-success"><i class="fa fa-table"></i> Confidence Dari Itemset 2</h6>
        </div>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-success"><i class="fa fa-table"></i> Data Proses</h6>
        </div>
        ...
        <div class="card-body">
            <table class='table table-bordered'>
                ...
                foreach ($data_confidence as $key => $val) {
                    if ($no == 1) {
                        echo "<tr><th>";
                        echo "Min support</th><td>" . $val['min_support'];
                        echo "</td></tr>";
                        echo "<tr><th>Min confidence</th><td>" . $val['min_confidence'];
                        echo "</td></tr>";
                        echo "<tr><th>Start Date</th><td>" . format_date_db($val['start_date']);
                        echo "</td></tr>";
                        echo "<tr><th>End Date</th><td>" . format_date_db($val['end_date']);
                        echo "</td></tr>";
                    }
                    $no++;
                }
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-success"><i class="fa fa-table"></i> Rule Asosiasi</h6>
        </div>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-header py-3 d-sm-flex align-items-center justify-content-between">
            <h6 class="m-0 font-weight-bold text-success"><i class="fa fa-table"></i> Hasil Analisa</h6>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-success"><i class="fa fa-table"></i> Perhitungan Itemset 1</h6>
        </div>
    ...
    echo "
			<div class='card shadow mb-4'>
    <div class='card-header py-3'>
        <h6 class='m-0 font-weight-bold text-success'><i class='fa fa-table'></i> Itemset 1 Yang Lolos</h6>
    </div>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-success"><i class="fa fa-table"></i> Perhitungan Itemset 2</h6>
        </div>
    ...
    <div class='card-header py-3'>
        <h6 class='m-0 font-weight-bold text-success'><i class='fa fa-table'></i> Itemset 2 Yang Lolos</h6>
    </div>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-success"><i class="fa fa-table"></i> Perhitungan Itemset 3</h6>
        </div>
    ...
    echo "<div class='card shadow mb-4'>
    <div class='card-header py-3'>
        <h6 class='m-0 font-weight-bold text-success'><i class='fa fa-table'></i> Itemset 3 Yang Lolos</h6>
    </div>
